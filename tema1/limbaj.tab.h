...
# define YYTOKENTYPE
  enum yytokentype
  {
    ...
    OR = 278,                      /* OR  */
    CLASS = 279,                   /* CLASS  */
    CLASS_SECTION = 280,           /* CLASS_SECTION  */
    VAR_SECT = 281,                /* VAR_SECT  */
    FUN_SECT = 282,                /* FUN_SECT  */
    INIT_SECT = 283,               /* INIT_SECT  */
    GLOBALVAR_SECTION = 284,       /* GLOBALVAR_SECTION  */
    GLOBALFUN_SECTION = 285,       /* GLOBALFUN_SECTION  */
    PRINT = 286,                   /* PRINT  */
    TYPEOF = 287                   /* TYPEOF  */
  };
